...
//	protected void drawRect(final Graphics g, final Color color, final GameObject obj) {
//		g.setColor(color);
//        g.fillRect((int) (obj.getX() - (obj.getWidth() / 2)), (int) (obj.getY() - (obj.getHeight() / 2)), obj.getWidth(), obj.getHeight());
//
//	}
