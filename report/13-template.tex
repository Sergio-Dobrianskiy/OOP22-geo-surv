...
\title{Meta-relazione per\\``\gametitle''}
...
\chapter{Obbiettivo}
L'obbiettivo è di realizzare un videogioco ispirato a “Vampire Survivors” (\href{https://store.steampowered.com/app/1794680/Vampire_Survivors/}{link Steampowered.com}), un reverse bullet hell 2D con visuale dall'alto centrata sul giocatore.
...
\section{Analisi e modello del dominio}
 ...
 Alla morte dei nemici dovranno apparire sul livello delle gemme che il giocatore dovrà poter raccogliaere per guadagnare esperienza o vita.
