...
%
\begin{enumerate}
\item Problematica: creare tipi di mostri diversi con metodi comuni
\begin{itemize}
	...
	\item Ho utilizzato il Pattern Factory Method per avere delle Factory che permettessero la creazione trasparente di mostri diversi.
\end{itemize}
...
\begin{itemize}
\item Soluzione Interface + Abstract Class
\item Schema
\item Pattern
\end{itemize}
