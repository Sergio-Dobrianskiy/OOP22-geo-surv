...
\begin{itemize}
	\item Movimento player (wasd) e nemici in campo
...
Se finiremo di sviluppare prima del previsto le funzionalità scelte procederemo a dividerci equamente le funzionalità opzionali.
