...
\begin{enumerate}
	...
	\begin{itemize}
		\item Problema 1: creare un'istanza delle armi presenti nel gioco durante la fase di loading indipendentemente dall'implmentazione della classe astratta Weapon.
