...
\begin{enumerate}
	...
	\begin{itemize}
		...
		In questo modo per assegnare lo stesso comportamento a più di una classe non sarà necessario scrivere lo stesso codice più volte o usare l'ereditarietà.
